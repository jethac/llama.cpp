...
SOURCE_FATTN_VEC_NVFP4 = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.

#include "../fattn-vec.cuh"

DECL_FATTN_VEC_CASE(256, GGML_TYPE_NVFP4, GGML_TYPE_NVFP4);
DECL_FATTN_VEC_CASE(512, GGML_TYPE_NVFP4, GGML_TYPE_NVFP4);
...
with open("fattn-vec-instance-nvfp4-nvfp4.cu", "w") as f:
    f.write(SOURCE_FATTN_VEC_NVFP4)
