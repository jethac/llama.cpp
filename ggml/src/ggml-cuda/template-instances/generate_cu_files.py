...
SOURCE_FATTN_VEC_NVFP4_SPLIT = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.
...
with open("fattn-vec-instance-nvfp4-nvfp4-split.cu", "w") as f:
    f.write(SOURCE_FATTN_VEC_NVFP4_SPLIT)
